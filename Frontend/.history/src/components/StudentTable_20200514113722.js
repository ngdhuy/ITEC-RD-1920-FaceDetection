...
export class StudentTable extends Component {
    ...
    newStudent() {
      ...
      editMailAccounts = (id) => {
        this.mailAccounsService.getMailAccountById(id)
            .then(res =StudentDataService> {
                this.setState({
                    formVisible : true,
                    selectedRow : res
                })
    ...
    actionTemplate(rowData, column) {
        return ( <React.Fragment>
         <Button icon="pi pi-pencil" className="p-button-warning" style={{ 'float': 'right' }} onClick={(e) => this.(rowData.id)} />
