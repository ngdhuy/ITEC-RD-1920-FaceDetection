...
saveStudent() {
    ...
    render() {
        ...
        return (
            ...
            <div>
            <Sidebar visible={this.state.visibleRight} position="right" baseZIndex={1000000} onHide={(e) => this.setState({visibleRight: false,add:false})} style={{width: '30%'}}>
                ...
                <br/>
                <Button type="button" onClick={(e) => this.updateStudent(this.state.student_id)} label="Submit" className="p-button-success"  style={{marginRight:'.25em'}} />
