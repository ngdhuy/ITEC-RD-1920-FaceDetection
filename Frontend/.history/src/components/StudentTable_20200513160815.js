...
export class StudentTable extends Component {
    ...
    newStudent() {
      ...
      deleteStudent() {    
        StudentDataService.delete(this.state.students)
          .then(response => {
            console.log(response.data);
                ...
                <div className="p-col-12">
                    {this.state.isAdmin ?
                        <div className="card card-w-title datatable-demo">
                            ...
                            responsive={true}  selectionMode="multiple" selection={this.state.selectedCars} onSelectionChange={e => this.setState({selectedCars: e.value})} >
