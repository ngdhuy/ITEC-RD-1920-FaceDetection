...
export class AttendanceTable extends Component {
    ...
    actionTemplate=(rowData, column) =>{
        return ( 
        <React.Fragment>
            <Button type="button" icon="pi-md-pencil" className="p-button-warning"  onClick={(e) => this.openEditAttendance(rowData.student_of_course_id)} />
            <Button icon="pi-md-close" className="p-button-danger" style={{ 'float': 'right' }} onClick={(e) => this.deleteNotify.delete(rowData.student_of_course_id)} />
            </React.Fragment>
        );
    }
