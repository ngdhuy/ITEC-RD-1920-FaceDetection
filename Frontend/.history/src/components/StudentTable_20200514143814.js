                    ...
                    {this.state.isAdmin ?
                        <div className="card card-w-title datatable-demo">
                            ...
                            <DataTable value={this.state.students} ref={(el) => this.dt = el} selectionMode="single" header="Students List" paginator={true} rows={10}
                                ...
                                <Column field="student_id" header="Student ID"  sortable={false}  /> <Button icon="pi-md-close" className="p-button-danger" style={{ 'float': 'right' }} onClick={(e) => this.deleteNotify.delete(rowData.student_id)} />
                                ...
                                <Column  header= {actionHeader} field ="" style={{ textAlign: 'center', width: '8em' }} />
