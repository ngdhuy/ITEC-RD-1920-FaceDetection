    ...
    render() {
        const dialogFooter = (
            <div>
                ...
                <Button icon="pi-md-close" onClick={() => this.setState({display:false})} label="No" className="p-button-secondary" />
            </div>
        );
        ...
        return (
            <div className="p-grid p-fluid">
                <div className="p-col-12 p-lg-6">
                    ...
                    <div className="card">
                        <h1>Dialog</h1>
                        <Dialog header="Godfather I" visible={this.state.display} style={{width: '30vw'}} baseZIndex={1000000} modal={true} footer={dialogFooter} onHide={() => this.setState({display:false})}>
