...
export class StudentTable extends Component {
    ...
    deleteStudent() {    
        StudentDataService.delete(this.state.sid)
          .then(response => {
                ...
                <div className="p-col-12">
                    {this.state.isAdmin ?
                        <div className="card card-w-title datatable-demo">
                            ...
                            <DataTable value={this.state.students} ref={(el) => this.dt = el} selectionMode="single" header="Students List" paginator={true} rows={2}
                                responsive={true} >
