...
export class StudentTable extends Component {
    ...
    actionTemplate(rowData, column) {
        return ( <React.Fragment>
            ...
            <Button icon="pi-md-close" className="p-button-danger" style={{ 'float': 'right' }} onClick={this.deleteStudent} />
            </React.Fragment>);
    }
    ...
    render() {
        ...
        return (
            <div className="p-grid">
                 <DeleteNotification ref={el => this.deleteNotify = el} accessDelete={(e) => this.deleteStudent(2)}
                />
