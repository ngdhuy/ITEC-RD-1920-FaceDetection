            ...
            <div className="p-grid">
                ...
                <Sidebar visible={this.state.visibleRight} position="right" baseZIndex={1000000} onHide={(e) => this.setState({visibleRight: false})} style={{width: '30%'}}>
                    <h1 style={{fontWeight:'normal'}}>Add Attendance</h1>
                        <div>
                            <h3>Student ID</h3><br/>
                            <InputText value={this.state.attendance_id} onChange={this.onChangeAttendanceId} id="student_id" name="student_id" /> <br/>
                            <h3>Student Name</h3><br/>
                            <InputText value={this.state.student_of_course_id} onChange={this.onChangeStudentOfCourse} id="name" name="name" /> <br/>
                            <h3>Student Email</h3><br/>
                            <InputText value={this.state.status} onChange={this.onChangeStatus} id="email" name="email" /> <br/>
                            <h3>Student Phone</h3><br/>
                            <InputText value={this.state.date_check} onChange={this.onChangeDateCheck} id="phone" name="phone" /> <br/>
                            <h3>Student Gender</h3><br/>
