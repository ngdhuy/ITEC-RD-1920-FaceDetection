    ...
    render() {
        ...
        return (
            <div className="p-grid">
                  <Button icon="pi-md-close" className="p-button-danger" style={{ 'float': 'right' }} onClick={(e) => this.deleteNotify.delete(2)} />
                    ...
                    {this.state.isAdmin ?
                        <div className="card card-w-title datatable-demo">
                            ...
                            <DataTable value={this.state.students} ref={(el) => this.dt = el} selectionMode="single" header="Students List" paginator={true} rows={10}
                                responsive={true}  header={header} editMode="row"  selectionMode="multiple" selection={this.state.selected} onSelectionChange={e => this.setState({selected: e.value})} >
